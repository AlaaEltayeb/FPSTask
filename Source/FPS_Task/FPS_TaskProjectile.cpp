...
AFPS_TaskProjectile::AFPS_TaskProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AFPS_TaskProjectile::OnHit);		// set up a notification for when this component hits something blocking
...
void AFPS_TaskProjectile::BeginPlay()
{
	Super::BeginPlay();
